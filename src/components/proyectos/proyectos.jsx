...
const Proyectos = ({ imgProyecto, nombreProyecto, descripcion, habilidades, urlRepositorio, urlDemo }) =>{
    return(
        <div className="card flex flex-col justify-center items-center mt-10 bg-white rounded-xl w-[46.5%] shadow-md transition-shadow duration-300 hover:shadow-lg">
            <div className="img bg-red-100 w-[100%] rounded-t-3xl">
            ...
            <div className="tecnologias pb-4 pt-2 w-[100%] flex justify-start flex-wrap gap-2 mb-4 pl-4">
