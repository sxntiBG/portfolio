...
const Estudios = ({
  ...
  return (
    <div className="card flex flex-col justify-center items-start mt-10 bg-white p-6 h-[200px] rounded-xl lg:w-[46.5%] w-full shadow-md transition-shadow duration-300 hover:shadow-lg">
